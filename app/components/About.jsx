    ...
    <div id="about">
      <div className="mt-32 text-center ">
        ...
        <div className="flex flex-col lg:flex-row  items-center lg:justify-center lg:gap-40 lg:items-start gap-5">
          ...
          <div>
            <p className="text-[13px] w-[25rem] sm:text-[14px] sm:w-[30rem] lg:text-[16px] lg:w-[40rem] lg:text-left">
            ...
            <div className=" mt-7 ">
              ...
              <div className=" flex gap-10 lg:justify-start justify-center overflow-y-visible ">
                <a href="https://code.visualstudio.com/" target="_blank">
                  <Image
                    alt=""
                    src={vscode}
                    className="w-10  mt-4 duration-500  bg-white rounded-xl  border p-2  hover:bg-slate-200 hover:shadow-shadowWhite hover:-translate-y-1"
                  />
                </a>
                <a href="https://www.figma.com/" target="_blank">
                  <Image
                    alt=""
                    src={figma}
                    className="w-10 duration-500 mt-4 bg-white rounded-xl border p-2  hover:bg-slate-200 hover:shadow-shadowWhite hover:-translate-y-1"
                  />
                </a>
                <a href="https://vercel.com/" target="_blank">
                  <Image
                    alt=""
                    src={vercel}
                    className="w-[40px] duration-500 mt-4 border rounded-xl bg-white r p-2  hover:bg-slate-200 hover:shadow-shadowWhite hover:-translate-y-1"
                  />
                </a>
                <a href="https://www.netlify.com/" target="_blank">
                  <Image
                    alt=""
                    src={netlify}
                    className="w-[40px] duration-500 mt-4 bg-white rounded-xl border p-2  hover:bg-slate-200 hover:shadow-shadowWhite hover:-translate-y-1"
                  />
                </a>
                <a href="https://github.com/" target="_blank">
                  <Image
                    alt=""
                    src={github}
                    className="w-[42px] duration-500 mt-4 bg-white rounded-xl border p-2 hover:bg-slate-200 hover:shadow-shadowWhite hover:-translate-y-1"
                  />
                </a>
              </div>{" "}
            </div>

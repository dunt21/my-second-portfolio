  ...
  return (
    <div className="">
      <div className=" flex flex-col items-center mx-auto mt-20 text-center gap-2">
        ...
        <p className="text-lg sm:text-xl flex gap-2 font-semibold lg:text-2xl">
          Hey There! I go by the name Suad Macaulay
          <Image src={hand} className="w-7" />
        </p>
        ...
        <p className=" text-[13px] w-[25rem] sm:text-[15px] sm:w-[38rem] mt-3 lg:text-[16px] lg:w-[45rem]">

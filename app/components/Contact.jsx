  ...
  return (
    ...
    >
      <div className="text-center">
        <h2 className=" text-3xl md:text-4xl font-bold  overflow-y-hidden mb-2 bg-gradient-to-r from-[#FF8660] to-[#9A33FF] text-transparent bg-clip-text">
          Want to collaborate with me?
        </h2>
        <p className=" text-xlmd:text-xl font-semibold ">
      ...
      <div className="flex gap-6">
        ...
        <a href=" " target="_blank">
          <Image
            ...
            src={email}
            className="w-[1.6rem] translate-y-1"
          />
        </a>
        <a href=" " target="_blank">
          <Image
        ...
        <a href=" " target="_blank">
          <Image alt="https://x.com/moreofababe" src={x} className="w-7" />
        </a>
      </div>
    </div>
  );
